...
window.addEventListener('DOMContentLoaded', function() {
  console.log("ready");
  dq("#fwd>.left", 'touchstart', function(e) { s("59"); });
  dq("#fwd>.middle", 'touchstart', function(e) { s("99"); });
  dq("#fwd>.right", 'touchstart', function(e) { s("95"); });
  dq("#mid>.left", 'touchstart', function(e) { s("09"); });
  dq("#mid>.middle", 'touchstart', function(e) { s("55"); });
  dq("#mid>.right", 'touchstart', function(e) { s("90"); });
  dq("#bwd>.left", 'touchstart', function(e) { s("50"); });
  dq("#bwd>.middle", 'touchstart', function(e) { s("00"); });
  dq("#bwd>.right", 'touchstart', function(e) { s("05"); });
